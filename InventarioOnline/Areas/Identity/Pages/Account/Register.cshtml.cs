...
namespace InventarioOnline.Areas.Identity.Pages.Account
{
    public class RegisterModel : PageModel
    {
        ...
        public class InputModel
        {
            ...
            /// </summary>
            [Required]
            [StringLength(100, ErrorMessage = "La {0} debe estar entre {2} y {1} caracteres.", MinimumLength = 6)]
        ...
        public async Task OnGetAsync(string returnUrl = null)
        {
            ...
            {
                RoleList = _roleManager.Roles.Where(x => x.Name != DS.Role_Cliente).Select(x => x.Name).
